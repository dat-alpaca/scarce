...
At the time of writing, the testbed application size is sitting at aroung 1 KiB, and the total resident memory used is around 26 MiB (Fedora 43 Plasma), or around 30 MiB (Fedora 43 Plasma X11), with a few extra megabytes when using the GLFW windowing system. The entire game runs on a 1KiB memory chunk.
